...
function renderCompare(compType, items) {
  var cells = items.map(function(item) {
    ...
    var fs = isLarge ? '4.2rem' : '2rem';
    return '<div style="display:flex;flex-direction:column;align-items:center;justify-content:flex-end;gap:6px;min-width:80px">'
         + '<span style="font-size:' + fs + ';line-height:1;display:block">' + item.emoji + '</span>'
         + '<span style="font-size:0.85rem;font-family:\'Fredoka One\',cursive;color:#333;text-align:center">' + item.label + '</span>'
         + '</div>';
  }).join('');
  return '<div style="display:flex;align-items:flex-end;justify-content:center;gap:32px;padding:18px 12px 10px;background:#f5f7ff;border-radius:16px;border:2px solid #dde3ff">' + cells + '</div>';
}
...
function showStorePrompt() {
  ...
  var PET_INFO = {
    ...
    'turtle':   { emoji:'🐢', name:'Turtle',    food:'turtle-food',   bed:'duck-pond'        },
    'duck':     { emoji:'🐥', name:'Ducky',     food:'duck-food',     bed:'duck-pond'        },
    'hamster':  { emoji:'🐹', name:'Hamster',   food:'hamster-food',  bed:'hamster-habitat'  },
    'owl':      { emoji:'🦉', name:'Owl',       food:'owl-food',      bed:'bird-perch'       },
    'hedgehog': { emoji:'🦔', name:'Hedgehog',  food:'hedgehog-food', bed:'cozy-burrow'      },
    'lamb':     { emoji:'🐑', name:'Lamb',      food:'lamb-food',     bed:'farm-barn'        },
    'bunny':    { emoji:'🐰', name:'Bunny',     food:'bunny-food',    bed:'bunny-house'      },
    'ferret':   { emoji:'🐾', name:'Ferret',    food:'ferret-food',   bed:'cozy-burrow'      },
    'monkey':   { emoji:'🐵', name:'Monkey',    food:'monkey-food',   bed:'jungle-treehouse' },
    'piggy':    { emoji:'🐷', name:'Piggy',     food:'piggy-food',    bed:'farm-barn'        },
    'robo-dog': { emoji:'🤖', name:'Robo Dog',  food:'robo-dog-fuel', bed:'robo-doghouse'     },
    'robo-cat': { emoji:'🐱', name:'Robo Cat',  food:'robo-cat-fuel', bed:'robo-cat-pod'      },
    'puppy-pet':{ emoji:'🐶', name:'Puppy',     food:'dog-food',      bed:'doghouse'          },
    'kitty-pet':{ emoji:'🐱', name:'Kitty',     food:'cat-food',      bed:'cat-castle'        },
    'pony':     { emoji:'🐴', name:'Pony',      food:'pony-food',     bed:'pastel-stable'     },
    'parrot':   { emoji:'🦜', name:'Parrot',    food:'parrot-food',   bed:'bird-perch'        },
    'alien':    { emoji:'👽', name:'Alien',     food:'alien-food',    bed:'alien-pod'         },
    'dino':     { emoji:'🦕', name:'Dino',      food:'dino-food',     bed:'dino-hideout'      },
    'chicken':  { emoji:'🐔', name:'Chicken',   food:'chicken-food',  bed:'chicken-coop'      },
    'snake':    { emoji:'🐍', name:'Snake',     food:'snake-food',    bed:'swamp-terrarium'   },
    'lizard':   { emoji:'🦎', name:'Lizard',    food:'lizard-food',   bed:'swamp-terrarium'   },
    'cow':      { emoji:'🐮', name:'Cow',       food:'cow-food',      bed:'farm-barn'         },
    'goat':     { emoji:'🐐', name:'Goat',      food:'goat-food',     bed:'farm-barn'         },
