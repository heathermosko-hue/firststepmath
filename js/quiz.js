...
function showStorePrompt() {
  ...
  var PET_INFO = {
    ...
    'turtle':   { emoji:'🐢', name:'Turtle',    food:'turtle-food',   bed:'fish-tank'  },
    'duck':     { emoji:'🐥', name:'Ducky',     food:'duck-food',     bed:'pet-bed'    },
    'hamster':  { emoji:'🐹', name:'Hamster',   food:'hamster-food',  bed:'pet-bed'    },
    'owl':      { emoji:'🦉', name:'Owl',       food:'owl-food',      bed:'pet-bed'    },
    'hedgehog': { emoji:'🦔', name:'Hedgehog',  food:'hedgehog-food', bed:'pet-bed'    },
    'lamb':     { emoji:'🐑', name:'Lamb',      food:'lamb-food',     bed:'pastel-stable'     },
    'bunny':    { emoji:'🐰', name:'Bunny',     food:'bunny-food',    bed:'bunny-house'       },
    'ferret':   { emoji:'🐾', name:'Ferret',    food:'ferret-food',   bed:'pet-carrier'       },
    'monkey':   { emoji:'🐵', name:'Monkey',    food:'monkey-food',   bed:'pet-bed'           },
    'piggy':    { emoji:'🐷', name:'Piggy',     food:'piggy-food',    bed:'pet-bed'           },
