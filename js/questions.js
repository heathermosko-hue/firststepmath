  ...
  prek: {
    ...
    measurement: {
      ...
      questions: [
        ...
        { q: "Which is TALLER?",  visual: { type:"compare", compare:"tall", items:[{emoji:"🦒", label:"Giraffe", size:"large"},{emoji:"🐱", label:"Cat",    size:"small"}] }, answers: ["Giraffe","Cat"],    correct: "Giraffe",  standard:"PK.M.1" },
        ...
        { q: "Which is LONGER?",  visual: { type:"compare", compare:"long", items:[{emoji:"🚌", label:"Bus",     size:"large"},{emoji:"🚲", label:"Bike",   size:"small"}] }, answers: ["Bus","Bike"],       correct: "Bus",      standard:"PK.M.1" },
        ...
        { q: "Which is BIGGER?",  visual: { type:"compare", compare:"big",  items:[{emoji:"🌳", label:"Tree",    size:"large"},{emoji:"🍎", label:"Apple",  size:"small"}] }, answers: ["Tree","Apple"],     correct: "Tree",     standard:"PK.M.1" },
