...
const QUESTIONS = {
  ...
  prek: {
    ...
    measurement: {
      ...
      standard: "PK.M.1–3",
      questions: [
        { q: "Circle the TALLER one.",  visual: { type:"compare", compare:"tall", items:[{emoji:"🌳", label:"Tree",    size:"large"},{emoji:"🌸", label:"Flower", size:"small"}] }, answers: ["Tree","Flower"],    correct: "Tree",     standard:"PK.M.1" },
        { q: "Circle the TALLER one.",  visual: { type:"compare", compare:"tall", items:[{emoji:"🦒", label:"Giraffe", size:"large"},{emoji:"🐱", label:"Cat",    size:"small"}] }, answers: ["Giraffe","Cat"],    correct: "Giraffe",  standard:"PK.M.1" },
        { q: "Circle the TALLER one.",  visual: { type:"compare", compare:"tall", items:[{emoji:"🏠", label:"House",   size:"large"},{emoji:"🚗", label:"Car",    size:"small"}] }, answers: ["House","Car"],      correct: "House",    standard:"PK.M.1" },
        { q: "Circle the LONGER one.",  visual: { type:"compare", compare:"long", items:[{emoji:"✏️", label:"Pencil",  size:"large"},{emoji:"🖍️", label:"Crayon", size:"small"}] }, answers: ["Pencil","Crayon"],  correct: "Pencil",   standard:"PK.M.1" },
        { q: "Circle the LONGER one.",  visual: { type:"compare", compare:"long", items:[{emoji:"🚌", label:"Bus",     size:"large"},{emoji:"🚲", label:"Bike",   size:"small"}] }, answers: ["Bus","Bike"],       correct: "Bus",      standard:"PK.M.1" },
        { q: "Circle the LONGER one.",  visual: { type:"compare", compare:"long", items:[{emoji:"🐍", label:"Snake",   size:"large"},{emoji:"🐛", label:"Worm",   size:"small"}] }, answers: ["Snake","Worm"],     correct: "Snake",    standard:"PK.M.1" },
        { q: "Circle the BIGGER one.",  visual: { type:"compare", compare:"big",  items:[{emoji:"🐘", label:"Elephant",size:"large"},{emoji:"🐭", label:"Mouse",  size:"small"}] }, answers: ["Elephant","Mouse"], correct: "Elephant", standard:"PK.M.1" },
        { q: "Circle the BIGGER one.",  visual: { type:"compare", compare:"big",  items:[{emoji:"🌳", label:"Tree",    size:"large"},{emoji:"🍎", label:"Apple",  size:"small"}] }, answers: ["Tree","Apple"],     correct: "Tree",     standard:"PK.M.1" },
        { q: "Circle the BIGGER one.",  visual: { type:"compare", compare:"big",  items:[{emoji:"🐋", label:"Whale",   size:"large"},{emoji:"🐟", label:"Fish",   size:"small"}] }, answers: ["Whale","Fish"],     correct: "Whale",    standard:"PK.M.1" },
        { q: "A giraffe is ? than a cat.",    visual: { type:"compare", compare:"tall", items:[{emoji:"🦒", label:"Giraffe", size:"large"},{emoji:"🐱", label:"Cat",   size:"small"}] }, answers: ["taller","shorter","same"],  correct: "taller",  standard:"PK.M.3" },
        { q: "A snake is ? than a worm.",     visual: { type:"compare", compare:"long", items:[{emoji:"🐍", label:"Snake",   size:"large"},{emoji:"🐛", label:"Worm",  size:"small"}] }, answers: ["longer","shorter","same"],  correct: "longer",  standard:"PK.M.3" },
        { q: "An elephant is ? than a mouse.",visual: { type:"compare", compare:"big",  items:[{emoji:"🐘", label:"Elephant",size:"large"},{emoji:"🐭", label:"Mouse", size:"small"}] }, answers: ["bigger","smaller","same"],  correct: "bigger",  standard:"PK.M.3" },
        { q: "A pencil is ? than a crayon.",  visual: { type:"compare", compare:"long", items:[{emoji:"✏️", label:"Pencil",  size:"large"},{emoji:"🖍️", label:"Crayon",size:"small"}] }, answers: ["longer","shorter","same"],  correct: "longer",  standard:"PK.M.3" },
      ]
    },
    ...
    sorting: {
      ...
      standard: "PK.AF.1",
      questions: [
        { q: "How are these sorted?", visual: { type:"compare", compare:"big", items:[{emoji:"🍎", label:"Big", size:"large"},{emoji:"🍎", label:"Small", size:"small"}] },                    answers: ["Size","Shape","Colour","Type"], correct: "Size",   standard:"PK.AF.1" },
        { q: "How are these sorted?", visual: { type:"compare", compare:"big", items:[{emoji:"🐻", label:"Big", size:"large"},{emoji:"🐻", label:"Small", size:"small"}] },                    answers: ["Size","Shape","Colour","Type"], correct: "Size",   standard:"PK.AF.1" },
        { q: "How are these sorted?", visual: { type:"compare", compare:"tall", items:[{emoji:"🌳", label:"Tall", size:"large"},{emoji:"🌸", label:"Short", size:"small"}] },                  answers: ["Size","Shape","Colour","Type"], correct: "Size",   standard:"PK.AF.1" },
        { q: "How are these sorted?", visual: { type:"emoji_row", items:["🟢","🔵","⭕","🟡"] },                                                                                               answers: ["Size","Shape","Colour","Type"], correct: "Shape",  standard:"PK.G.1" },
        { q: "How are these sorted?", visual: { type:"emoji_row", items:["🔺","📐","🔻","⚠️"] },                                                                                               answers: ["Size","Shape","Colour","Type"], correct: "Shape",  standard:"PK.G.1" },
        { q: "How are these sorted?", visual: { type:"emoji_row", items:["🟥","🍎","🌹","❤️"] },                                                                                               answers: ["Size","Shape","Colour","Type"], correct: "Colour", standard:"PK.NS.1" },
