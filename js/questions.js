...
const QUESTIONS = {
  ...
  prek: {
    ...
    measurement: {
      ...
      standard: "PK.M.1–3",
      questions: [
        { q: "Which is TALLER?",  visual: { type:"img", src:"img/cmp-taller-1.png" }, answers: ["Tree","Flower"],    correct: "Tree",     standard:"PK.M.1" },
        { q: "Which is TALLER?",  visual: { type:"img", src:"img/cmp-taller-2.png" }, answers: ["Giraffe","Cat"],    correct: "Giraffe",  standard:"PK.M.1" },
        { q: "Which is TALLER?",  visual: { type:"img", src:"img/cmp-taller-3.png" }, answers: ["House","Car"],      correct: "House",    standard:"PK.M.1" },
        { q: "Which is LONGER?",  visual: { type:"img", src:"img/cmp-longer-1.png" }, answers: ["Pencil","Crayon"],  correct: "Pencil",   standard:"PK.M.1" },
        { q: "Which is LONGER?",  visual: { type:"img", src:"img/cmp-longer-2.png" }, answers: ["Bus","Bike"],       correct: "Bus",      standard:"PK.M.1" },
        { q: "Which is LONGER?",  visual: { type:"img", src:"img/cmp-longer-3.png" }, answers: ["Snake","Worm"],     correct: "Snake",    standard:"PK.M.1" },
        { q: "Which is BIGGER?",  visual: { type:"img", src:"img/cmp-bigger-1.png" }, answers: ["Elephant","Mouse"], correct: "Elephant", standard:"PK.M.1" },
        { q: "Which is BIGGER?",  visual: { type:"img", src:"img/cmp-bigger-2.png" }, answers: ["Tree","Apple"],     correct: "Tree",     standard:"PK.M.1" },
        { q: "Which is BIGGER?",  visual: { type:"img", src:"img/cmp-bigger-3.png" }, answers: ["Whale","Fish"],     correct: "Whale",    standard:"PK.M.1" },
        { q: "A giraffe is ? than a cat.",    visual: { type:"img", src:"img/cmp-taller-2.png" }, answers: ["taller","shorter","same"],  correct: "taller",  standard:"PK.M.3" },
        { q: "A snake is ? than a worm.",     visual: { type:"img", src:"img/cmp-longer-3.png" }, answers: ["longer","shorter","same"],  correct: "longer",  standard:"PK.M.3" },
        { q: "An elephant is ? than a mouse.",visual: { type:"img", src:"img/cmp-bigger-1.png" }, answers: ["bigger","smaller","same"],  correct: "bigger",  standard:"PK.M.3" },
        { q: "A pencil is ? than a crayon.",  visual: { type:"img", src:"img/cmp-longer-1.png" }, answers: ["longer","shorter","same"],  correct: "longer",  standard:"PK.M.3" },
      ]
    },
