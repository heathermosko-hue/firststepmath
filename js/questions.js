...
const QUESTIONS = {
  ...
  prek: {
    ...
    patterns: {
      ...
      standard: "PK.AF.1–2",
      questions: [
        { type:"pattern_complete", q:"What comes next in the pattern?", pattern:["🔴","🔵","🔴","🔵","🔴","?"], choices:["🔴","🔵","🟡","🟢"], correct:"🔵", standard:"PK.AF.2" },
        { type:"pattern_complete", q:"What comes next in the pattern?", pattern:["⭐","🌙","⭐","🌙","⭐","?"], choices:["⭐","🌙","☀️","💫"], correct:"🌙", standard:"PK.AF.2" },
        { type:"pattern_complete", q:"What comes next in the pattern?", pattern:["🐱","🐶","🐱","🐶","🐱","?"], choices:["🐱","🐶","🐰","🐻"], correct:"🐶", standard:"PK.AF.2" },
        { type:"pattern_complete", q:"What comes next in the pattern?", pattern:["🍎","🍊","🍎","🍊","🍎","?"], choices:["🍎","🍊","🍋","🍇"], correct:"🍊", standard:"PK.AF.2" },
        { type:"pattern_complete", q:"What comes next in the pattern?", pattern:["🔺","🟦","🔺","🟦","🔺","?"], choices:["🔺","🟦","🟡","🔴"], correct:"🟦", standard:"PK.AF.2" },
        { type:"pattern_complete", q:"What comes next in the pattern?", pattern:["🐸","🦋","🐸","🦋","🐸","?"], choices:["🐸","🦋","🐢","🐝"], correct:"🦋", standard:"PK.AF.2" },
    ...
    shapes2d: {
      ...
      questions: [
        ...
        { q: "How many sides does a triangle have?",visual: { type:"emoji", content:"🔺" }, answers: ["2","3","4","5"],     correct: "3",         standard:"PK.G.1" },
        { q: "How many sides does a square have?",  visual: { type:"emoji", content:"🟦" }, answers: ["3","4","5","6"],     correct: "4",         standard:"PK.G.1" },
        { q: "Which shape has 0 corners?",          visual: null, answers: ["Triangle","Square","Circle","Rectangle"], correct: "Circle",    standard:"PK.G.1" },
        { q: "What shape is a door? 🚪",            visual: { type:"emoji", content:"🚪" }, answers: ["Circle","Triangle","Rectangle","Star"],   correct: "Rectangle", standard:"PK.G.3" },
    ...
    measurement: {
      ...
      standard: "PK.M.1–3",
      questions: [
        { q: "Which animal is TALLER?",   visual: null, answers: ["Mouse 🐭","Elephant 🐘","Cat 🐱","Dog 🐶"],      correct: "Elephant 🐘",  standard:"PK.M.1" },
        { q: "Which is SHORTER?",         visual: null, answers: ["Tree 🌳","Flower 🌸","House 🏠","Car 🚗"],       correct: "Flower 🌸",    standard:"PK.M.1" },
        { q: "A whale is ? than a fish.",visual:null, answers: ["shorter","smaller","bigger","lighter"],           correct: "bigger",        standard:"PK.M.3" },
        { q: "A feather is ? than a rock.",visual:null,answers:["heavier","taller","lighter","longer"],            correct: "lighter",       standard:"PK.M.3" },
